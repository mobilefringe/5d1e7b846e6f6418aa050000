        ...
        <div class="margin_25_across">
            ...
            <div class="row" id="promo_details_container">
                ...
                <div class="col-md-8 col-sm-8">
                    ...
                    <social-sharing :url="shareURL(currentEvent.slug)" :title="currentEvent.name" :description="currentEvent.body" :quote="truncate(currentEvent.body)" :media="currentEvent.image_url" inline-template>
